            ...
            <div class="col-lg-5">
                <main class="form-registration">
                    ...
                    <form action="/register" method="post">
                        @csrf
                        <img class="mb-1 img-fluid mx-auto px-5" src="images/register.svg" alt="" width="480">

                        <!-- masukan nama -->
                        <div class="form-floating">
                            <input type="text" name="name" class="form-control rounded-top @error('name') is-invalid @enderror" id="name" placeholder="Name" autofocus required value="{{ old('name') }}">
                        ...
                        <!-- jika sudah login -->
                        <small class="text-center d-block py-5">
                            Sudah siap login? <a href="/login">Login Sekarang</a>
                        </small>
                    </form>
                </main>
            </div>
